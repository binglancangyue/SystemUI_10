...
import com.android.systemui.customization.Customer;
...
public class NavigationBarView extends FrameLayout implements
    ...
    //add by lym
    private Rect mSettingsButtonBounds = new Rect();
    private Rect mVoiceButtonBounds = new Rect();
    private Rect mCameraButtonBounds = new Rect();
    private KeyButtonDrawable mSettingsIcon;
    private KeyButtonDrawable mVoiceIcon;
    private KeyButtonDrawable mCameraIcon;
    //end
    ...
    private final int nav_icon_type = Customer.NAVIGATION_BAR_ICON_TYPE;
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        //add by lym
        final ContextualButton settingsButton = new ContextualButton(R.id.sys_settings, 0);
        final ContextualButton voiceButton = new ContextualButton(R.id.voice, 0);
        final ContextualButton cameraButton = new ContextualButton(R.id.camera, 0);
        //end
        ...
        //add by lym
        mButtonDispatchers.put(R.id.sys_settings, settingsButton);
        mButtonDispatchers.put(R.id.voice, voiceButton);
        mButtonDispatchers.put(R.id.camera, cameraButton);
        //end
    ...
    public ButtonDispatcher getSettingsButton() {
        return mButtonDispatchers.get(R.id.sys_settings);
    }
    ...
    public ButtonDispatcher getCameraButton() {
        return mButtonDispatchers.get(R.id.camera);
    }
    /*****************end*****************/
    ...
    private void updateIcons(Configuration oldConfig) {
        ...
        if (orientationChange || densityChange || dirChange) {
            ...
            mSettingsIcon = getSystemSettingsDrawable();
            mVoiceIcon = getVoiceDrawable();
            mCameraIcon = getCameraDrawable();
        }
    }
    ...
    public @DrawableRes int getBackDrawableRes() {
        return chooseNavigationIconDrawableRes(Customer.BACK_ICON[nav_icon_type],
                Customer.BACK_ICON[nav_icon_type]);
    }

    public KeyButtonDrawable getHomeDrawable() {
        final boolean quickStepEnabled = mOverviewProxyService.shouldShowSwipeUpUI();
        KeyButtonDrawable drawable = quickStepEnabled
                ? getDrawable(Customer.HOME_ICON[nav_icon_type])
                : getDrawable(Customer.HOME_ICON[nav_icon_type]);
    ...
    public KeyButtonDrawable getSystemSettingsDrawable() {
//        KeyButtonDrawable drawableSetting = getDrawable(getSystemSettingsDrawableRes());
        final boolean quickStepEnabled = mOverviewProxyService.shouldShowSwipeUpUI();
        KeyButtonDrawable drawableSetting = quickStepEnabled
                ? getDrawable(Customer.SETTINGS_ICON[nav_icon_type])
                : getDrawable(Customer.SETTINGS_ICON[nav_icon_type]);
        return drawableSetting;
    }

    public @DrawableRes
    int getSystemSettingsDrawableRes() {
        return chooseNavigationIconDrawableRes(Customer.SETTINGS_ICON[nav_icon_type],
                Customer.SETTINGS_ICON[nav_icon_type]);
    }

    public KeyButtonDrawable getVoiceDrawable() {
        KeyButtonDrawable drawable = getDrawable(getVoiceDrawableRes());
        return drawable;
    }

    public @DrawableRes
    int getVoiceDrawableRes() {
        return chooseNavigationIconDrawableRes(Customer.VOICE_ICON[nav_icon_type],
                Customer.VOICE_ICON[nav_icon_type]);
    }

    public KeyButtonDrawable getCameraDrawable() {
        KeyButtonDrawable drawable = getDrawable(getCameraDrawableRes());
        return drawable;
    }

    public @DrawableRes
    int getCameraDrawableRes() {
        return chooseNavigationIconDrawableRes(Customer.CAMERA_ICON[nav_icon_type],
                Customer.CAMERA_ICON[nav_icon_type]);
    }
    /********************* end *********************/
    ...
    public void updateNavButtonIcons() {
        ...
        updateRecentsIcon();
        //add by lym start
        KeyButtonDrawable voiceIcon = mVoiceIcon;
        KeyButtonDrawable settingsIcon = mSettingsIcon;
        KeyButtonDrawable cameraIcon = mCameraIcon;
        getVoiceButton().setImageDrawable(voiceIcon);
        getSettingsButton().setImageDrawable(settingsIcon);
        getCameraButton().setImageDrawable(cameraIcon);
        //end
        ...
        //add by lym start
        getSettingsButton().setVisibility(disableHome ? View.INVISIBLE : View.VISIBLE);
        getCameraButton().setVisibility(disableHome ? View.INVISIBLE : View.VISIBLE);
        getVoiceButton().setVisibility(disableHome ? View.INVISIBLE : View.VISIBLE);
        //end
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //add by lym start
        updateButtonLocation(getSettingsButton(), mSettingsButtonBounds, false);
        updateButtonLocation(getVoiceButton(), mVoiceButtonBounds, false);
        updateButtonLocation(getCameraButton(), mCameraButtonBounds, false);
        //end
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        //add by lym start
        dumpButton(pw, "systemsetting", getSettingsButton());
        dumpButton(pw, "camera", getCameraButton());

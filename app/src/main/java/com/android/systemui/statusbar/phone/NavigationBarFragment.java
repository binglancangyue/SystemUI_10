...
import com.android.systemui.customization.NotifyMessageManager;
import com.android.systemui.customization.SettingsWindowActivity;
...
public class NavigationBarFragment extends LifecycleFragment implements Callbacks,
        NavigationModeController.ModeChangedListener, OnShowSettingsWindowListener {
    ...
    private void prepareNavigationBarView() {
        ...
        ButtonDispatcher cameraButton = mNavigationBarView.getCameraButton();
        settingsButton.setOnClickListener(this::onShowSettingsWindow);
        voiceButton.setOnClickListener(this::onShowTXUI);
        cameraButton.setOnClickListener(this::onOpenCamera);
        //end
    ...
    /********************* add by lym *********************/
    private void onShowTXUI(View view) {
        Log.d(TAG, "onShowTXUI: ");
    ...
    private void onOpenCamera(View view) {
    ...
    private void onShowSettingsWindow(View view) {
        Log.d(TAG, "onShowSettingsWindow: ");
        Context context = getContext();
    ...
    public void ShowSettingsWindow() {
        Log.d(TAG, "ShowSettingsWindow:call back ");
        onShowSettingsWindow(null);
    }

...
import com.android.systemui.customization.StatusChangeBroadcastReceiver;
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    //add by lym start
    private StatusChangeBroadcastReceiver mReceiver;
    //end
    ...
    public void start() {
        ...
        //add by lym start
        mReceiver = new StatusChangeBroadcastReceiver();
    ...
    private void registerSettingsReceiver() {
        ...
        intentFilter.addAction(Customer.ACTION_FM_STATE_CHANGED);
        intentFilter.addAction(ConnectivityManager.CONNECTIVITY_ACTION);
//        intentFilter.addAction(CustomValue.ACTION_SEND_TO_SYSTEM_UI);
        intentFilter.addAction(WifiManager.RSSI_CHANGED_ACTION);
//        intentFilter.addAction(Intent.ACTION_BATTERY_CHANGED);
        intentFilter.addAction(Customer.ACTION_VOLUME_CHANGED);
        intentFilter.addAction(WifiManager.WIFI_AP_STATE_CHANGED_ACTION);
//        intentFilter.addAction("android.intent.action.MEDIA_REMOVED");
//        intentFilter.addAction("android.intent.action.MEDIA_UNMOUNTED");
//        intentFilter.addAction("android.intent.action.MEDIA_MOUNTED");
        intentFilter.addAction(Customer.ACTION_SHOW_SETTING_WINDOW);
        intentFilter.addAction(Customer.ACTION_UPDATE_BRIGHTNESS_BY_TIME);
        intentFilter.addAction(Customer.ACTION_UPDATE_WEATHER);
        intentFilter.addAction("android.location.PROVIDERS_CHANGED");
        intentFilter.addAction(Intent.ACTION_SCREEN_OFF);
        intentFilter.addAction(Customer.ACTION_DISMISS_SETTINGS_DIALOG);

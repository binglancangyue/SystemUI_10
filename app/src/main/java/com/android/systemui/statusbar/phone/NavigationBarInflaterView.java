...
public class NavigationBarInflaterView extends FrameLayout
    ...
    //add by lym start
    public static final String SETTINGS = "sys_settings";
    ...
    protected String getDefaultLayout() {
        ...
        if (Customer.IS_T507) {
            return getContext().getString(R.string.config_navBarLayoutT507);
        }
    ...
    private View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        } else if (SETTINGS.equals(button)) {
            v = inflater.inflate(R.layout.nav_settings, parent, false);
        } else if (VOICE.equals(button)) {
            v = inflater.inflate(R.layout.voice, parent, false);
        } else if (CAMERA.equals(button)) {
            v = inflater.inflate(R.layout.camera, parent, false);

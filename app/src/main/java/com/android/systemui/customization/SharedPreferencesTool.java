...
public class SharedPreferencesTool {
    ...
    public void saveCameraFront(boolean value) {
        ...
        editor.apply();
        sendBroadcast("dvr_camera_front", value, Customer.ACTION_OPEN_DVR_CAMERA);
    }
    ...
    public void saveADALevel(int adasLevel) {
        ...
        editor.apply();
        sendBroadcast("adasLevel", adasLevel, Customer.ACTION_SET_ADAS_LEVEL);
    }
    ...
    public void saveCollisionLevel(int level) {
        ...
        editor.apply();
        sendBroadcast("g_sensor", level, Customer.ACTION_SET_G_SENSOR_LEVEL);
    }
